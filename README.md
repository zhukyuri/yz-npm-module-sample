...
The package is based on [npm-base](https://github.com/zhukyuri/yz-npm-module-sample) package by [Kadira](https://github.com/zhukyuri) which is really great when you want to prepare Npm package. This one is prepared to be used as a starter point for React components which needs to be published on Npm.
